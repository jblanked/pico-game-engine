...
static void player_render(Entity *self, Draw *draw, Game *game)
{
    ...
    draw->tft.drawRect(0, 0, SCREEN_SIZE_X, SCREEN_SIZE_Y, TFT_BLACK);
    ...
    draw->tft.fillRect(players->player1.x, players->player1.y, PAD_SIZE_X, PAD_SIZE_Y, TFT_DARKCYAN);
    ...
    draw->tft.fillRect(players->player2.x, players->player2.y, PAD_SIZE_X, PAD_SIZE_Y, TFT_DARKGREEN);
    ...
    draw->tft.fillRect(players->ball.x, players->ball.y, BALL_SIZE, BALL_SIZE, TFT_BLACK);
    ...
    draw->text(Vector(140, 120), buffer, 1, game->fg_color);
}
